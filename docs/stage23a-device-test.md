...
- [ ] Book a new SELF or FAMILY hosted appointment; confirm its history card shows clinic fee PENDING and says the receipt will be generated after clinic confirmation.
...
- [ ] Repeat with a dummy appointment confirmed as WAIVED; confirm Patient shows WAIVED and its receipt reference without a paid amount.
