...
- [x] Publish or reuse both an active Doctor announcement and Admin broadcast; confirm one card for each appears on Home.
...
Final retest on 22 July 2026 passed simultaneous Doctor announcement and Admin broadcast visibility. Stage 24A is accepted.
